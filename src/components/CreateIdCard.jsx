  ...
  return (
    <div className="flex items-center justify-between bgt-blue3 text-white rounded-[10px] px-2 py-3 w-full shadow-md">
      ...
      <div className="flex items-center space-x-3">
        <img src={`asset/${logo}`} alt="Logo" className="w-[71px] h-[71px] rounded-full object-cover" />
        <div>
      ...
      {/* Button */}
      <button onClick={onClick} className="bgt-blue2 px-5 py-1.5 rounded-[10px] font-medium text-[15px]">
        {buttonText}
      </button>
    </div>
  );
