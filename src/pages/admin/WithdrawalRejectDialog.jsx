...
const WithdrawalRejectDialog = ({ gameId, onStatusUpdated, buttonLogo }) => {
  ...
  const handleReject = async () => {
    try {
      ...
      const res = await axios.patch(
        `${import.meta.env.VITE_URL}/api/withdraw/admin/status/${gameId}`,
        {
          status: "Rejected",
          remark,
        },
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Reject wallet withdrawal?</DialogTitle>
          <DialogDescription>
            Add a reason for rejecting this wallet withdrawal. This action
            cannot be undone.
          </DialogDescription>
        </DialogHeader>
...
export default WithdrawalRejectDialog;
