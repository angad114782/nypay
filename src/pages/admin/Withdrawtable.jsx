              ...
              <TableCell>
                <div className="flex flex-col">
                  <div className="flex items-center justify-between gap-1">
                    {item.details.name}
                    <button
                      onClick={() => handleCopy(item.details.name)}
                      title="Copy Name"
                      className="ml-1 p-1 hover:bg-gray-200 rounded"
                    >
                      <Copy className="h-4 w-4" />
                  ...
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <button
                      onClick={() => handleCopy(item.details.accountNumber)}
                  ...
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <button
                      onClick={() => handleCopy(item.details.IFSCCode)}
                  ...
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <button
                      onClick={() => handleCopy(item.details.bankName)}
                  ...
                  <button
                    ...
                    className="mt-1 px-2 py-1 rounded bg-gray-100 text-xs hover:bg-gray-200"
                  >
                    Copy All
                  </button>
                </div>
...
export const TransactionCard = ({ transaction }) => {
  ...
  return (
    <div className="bg-[#ffb3b3] rounded-lg shadow-md border border-gray-200 mb-4 overflow-hidden">
      {/* Header */}
      ...
      <div className=" flex justify-between  m-2  ">
        ...
        <div className="space-y-1  ">
          <div className="flex items-center ">
            ...
            <button
              onClick={() => handleCopy(transaction.details.name)}
              title="Copy Name"
              className="ml-1 p-1 hover:bg-gray-200 rounded"
            >
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() => handleCopy(transaction.details.accountNumber)}
              title="Copy Account Number"
              className="ml-1 p-1 hover:bg-gray-200 rounded"
            >
              <Copy className="w-4 h-4" />
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() => handleCopy(transaction.details.IFSCCode)}
              title="Copy IFSC Code"
              className="ml-1 p-1 hover:bg-gray-200 rounded"
            >
              <Copy className="w-4 h-4" />
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() => handleCopy(transaction.details.bankName)}
              title="Copy Bank Name"
              className="ml-1 p-1 hover:bg-gray-200 rounded"
            >
              <Copy className="w-4 h-4" />
