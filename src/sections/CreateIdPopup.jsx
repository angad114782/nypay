...
function CreateIdPopup({ cardData, onClose }) {
  ...
  const [createModalMessageType, setcreateModalMessageType] = useState("success");
  ...
  const createModalMessage = createModalMessages.find(n => n.type === createModalMessageType);
  useScrollLock(true);
  const popupContent = (
